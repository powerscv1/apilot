...
A_CRUISE_MAX_VALS = [1.0, 1.7, 2.0, 1.4, 0.5, 0.2, 0.15]
A_CRUISE_MAX_BP = [0., 5 * CV.KPH_TO_MS, 40 * CV.KPH_TO_MS, 60 * CV.KPH_TO_MS, 80 * CV.KPH_TO_MS, 110 * CV.KPH_TO_MS, 140 * CV.KPH_TO_MS]
